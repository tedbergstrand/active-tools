          ...
          <div className="flex flex-wrap items-end gap-4">
            ...
            <form onSubmit={handleSearch} className="flex items-center gap-2 flex-1 min-w-[200px]">
              <div className="relative flex-1">
                ...
                />
                {search && (
                  <button type="button" onClick={() => { setSearch(''); searchRef.current = ''; setOffset(0); fetchWorkouts(); }} className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-300">
                    <X size={14} />
                  </button>
                )}
              </div>
